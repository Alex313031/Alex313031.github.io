...
varying vec3 vTangentW, vBinormalW, vNormalW;
...
void main() {
    ...
    mat3 dTBN = mat3(normalize(vTangentW), normalize(vBinormalW), normalize(vNormalW));
    ...
    screenCoord = screenCoord * 2.0 - vec2(1.0);
